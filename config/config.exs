...
config :rockelivery, RockeliveryWeb.Auth.Guardian,
  issuer: "rockelivery",
  secret_key: "VfCNTyqJ+oslCwOEzxTvy5UQ7Y0xFFn9gOm/0cu7GQGCxjsulRNpq/n+x4S/XejN"
...
config :rockelivery, RockeliveryWeb.Endpoint,
  url: [host: "localhost"],
  secret_key_base: "RHRuhlm6mJr9lAiIM73WDlnsBVvG8gX80YwhOG/zr3CbpwSt7Gr2ykXJcG6dg5jj",
  render_errors: [view: RockeliveryWeb.ErrorView, accepts: ~w(json), layout: false],
  pubsub_server: Rockelivery.PubSub,
  live_view: [signing_salt: "TDABoMot"]
